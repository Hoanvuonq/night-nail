    ...
    >
      ...
      <div className="relative group shrink-0">
        ...
        <motion.div 
          ...
          className="absolute -top-10 -left-10 w-20 h-20 rounded-full bg-gradient-to-br from-[#D4AF37]/20 to-transparent blur-xl"
        />
        <motion.div 
          animate={{ y: [0, 20, 0], x: [0, -15, 0] }}
          transition={{ duration: 5, repeat: Infinity, delay: 1 }}
          className="absolute -bottom-5 -right-5 w-16 h-16 rounded-full bg-gradient-to-tr from-[#FFB6C1]/20 to-transparent blur-lg"
        />
        ...
        <div className="w-[280px] h-[280px] md:w-[420px] md:h-[420px] relative z-10 p-3">
           <motion.div 
             ...
             className="w-full h-full relative rounded-full overflow-hidden border-4 border-white/10 shadow-[0_0_40px_rgba(212,175,55,0.2)]"
           >
              <Image
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                <Sparkles className="absolute top-1/4 left-1/4 text-white animate-pulse" size={24} />
        ...
        <div className="absolute -top-2 right-4 w-14 h-14 bg-gradient-to-br from-[#FFD700] to-[#D4AF37] rounded-full z-20 flex flex-col items-center justify-center text-black shadow-lg">
      ...
      <div className={`flex flex-col gap-6 xl:w-[50%] ${reverse ? 'xl:text-right' : 'xl:text-left'} text-center z-10`}>
        ...
        <p className="text-lg md:text-xl text-white/70 font-light leading-relaxed font-serif italic italic">
          "{description}"
        </p>
        ...
        <div className={`pt-4 flex ${reverse ? 'xl:justify-end' : 'xl:justify-start'} justify-center`}>
           <div className="relative group/btn">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#D4AF37] to-[#FFB6C1] blur-2xl opacity-0 group-hover/btn:opacity-40 transition-opacity rounded-full" />
           </div>
        </div>
      </div>
