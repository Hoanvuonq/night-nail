export const Testimonials = () => (
  <section className="py-20 bg-[#080808] relative overflow-hidden">
    <div className="max-w-6xl mx-auto px-6">
      <h2 className="text-white font-serif text-5xl text-center mb-16">Cảm Nhận Từ <span className="text-[#D4AF37] italic">Nàng</span></h2>
        ...
        {[1, 2, 3].map((_, i) => (
          <div key={i} className="p-8 rounded-[2.5rem] bg-white/[0.03] border border-white/5 backdrop-blur-md relative">
            ...
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#D4AF37] to-[#F4D8CD]" />
              <div>
                <p className="text-white font-bold text-sm tracking-wide uppercase">Khách Hàng Xinh Đẹp</p>
