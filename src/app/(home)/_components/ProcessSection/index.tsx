...
export const Web3LuxuryCarousel = () => {
  ...
  return (
    <section className="py-32 overflow-hidden relative">
      <div className="absolute top-0 right-[-10%] w-150 h-150 bg-amber-100/40 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-5%] w-100 h-100 bg-amber-50/50 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-10">
          ...
          <motion.p
            ...
            className="text-zinc-600 text-base max-w-75 leading-relaxed border-l-2 border-amber-200 pl-8 hidden lg:block italic font-medium"
          >
        ...
        >
          {GALLERY_DATA.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -20 }}
              className="relative min-w-85 md:min-w-125 aspect-[3/4.2] rounded-[60px] overflow-hidden snap-center group border-8 border-white shadow-[0_40px_80px_-15px_rgba(0,0,0,0.08)] bg-white cursor-pointer"
            >
              <Image
                src={item.img}
                alt={item.title}
              ...
              <div className="absolute inset-0 bg-linear-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              <div className="absolute inset-0 p-12 flex flex-col justify-between z-10">
                <div className="flex justify-between items-start">
                  <motion.div
                    whileHover={{ rotate: 90 }}
                    className="w-16 h-16 rounded-3xl bg-white/40 backdrop-blur-xl border border-white/40 flex items-center justify-center text-amber-600 shadow-xl"
                  >
                ...
                <div className="space-y-6 translate-y-12 group-hover:translate-y-0 transition-transform duration-700 ease-[0.16,1,0.3,1]">
                  <h3 className="text-4xl md:text-4xl text-amber-100 font-bold tracking-tight drop-shadow-md">
                    {item.title}
                  </h3>
          ...
          <motion.div
            ...
            className="min-w-85 md:min-w-100 aspect-[3/4.2] rounded-[60px] border-4 border-dashed border-amber-300 bg-amber-50/30 flex flex-col items-center justify-center text-center p-14 snap-center group transition-all hover:bg-amber-50"
          >
